...
public final class SMSFactory {
	...
	public SMSFactory(String tempKey, String phone) throws Exception {
		...
		user_id = base64Encode("jykim6207");	//아이디
		secure = base64Encode("df1c51e953ba16d54fe15589007553a4");// 인증키
		...
		second_phone_number = base64Encode(nullcheck("4244", ""));
		third_phone_number = base64Encode(nullcheck("1989", ""));
